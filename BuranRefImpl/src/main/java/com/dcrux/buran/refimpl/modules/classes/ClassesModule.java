...
import com.dcrux.buran.refimpl.modules.nodeWrapper.ClassNameUtils;
...
public class ClassesModule extends Module<BaseModule> {
    ...
    public ClassId declareClass(ClassDefinition classDefinition) throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            //TODO: Fehlerhaft, wenn ein fehler, muss zuerst versucht werden über
            // getClassIdByClassHash die klasse zu holen (wie oben),
            // sonst gibs ggf. 2 verschiedene IDs für dieselbe classHash (oder wird je nach index
            // definition nie zu einem resultat führen).
