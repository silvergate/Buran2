 ...
 */
public class ComPreviewPeek extends Command<ComPreviewPeekResult> {
    ...
    public ComPreviewPeek(NidVer nidVer, FieldTarget binaryField, Optional<FieldTarget> mimeField,
